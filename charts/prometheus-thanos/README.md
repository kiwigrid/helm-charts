...
| `bucketWebInterface.image.tag` | Docker image tag for bucket web interface | `v0.11.0` |
...
| `compact.image.tag` | Docker image tag for store gateway | `v0.11.0` |
...
| `querier.image.tag` | Docker image tag for querier | `v0.11.0` |
...
| `ruler.image.tag` | Docker image tag for ruler | `v0.11.0` |
...
| `storeGateway.image.tag` | Docker image tag for store gateway | `v0.11.0` |
